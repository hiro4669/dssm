...
// DSSM用に提示を追加 --->
		SSM_READ_BUFFER = 0xa0,	// リングバッファ使用した読み込みフラグ
		SSM_MODE_MASK = 0xf0		// < フラグを取り出すためのマスク 
// <----
//		SSM_MODE_MASK = 0xe0						/**< フラグを取り出すためのマスク */
	...
	/**
	 * @brief ssm-coordinatorに情報を書き込み
	 * @param[in] *data 書き込むデータ
	 * @param[in] data_len 書き込むサイズ
	 * @retval 1 成功
	 * @retval 0 失敗
	 */
	...
	/**
	 * @brief ssm-coordinatorから取得する情報のサイズを返す
	 * 
	 * @return int 
	 * @retval サイズ
	 * @retval -1 失敗時
	...
	/**
	 * @brief ssm-coordinatorから情報を取得する
	 * @param[out] buffer ここに書き込む
	 * @retval 1 成功
	 * @retval 0 失敗
	 */
